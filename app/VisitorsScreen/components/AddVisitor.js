...
if (type === "guest") {
  return visitMode === "single"
    ? <SingleVisitorForm theme={theme} />
    : <FrequentVisitorForm theme={theme} />;
}

if (type === "delivery") {
  return visitMode === "single"
    ? <SingleDeliveryForm theme={theme} />
    : <FrequentDeliveryForm theme={theme} />;
}

if (type === "cab") {
  return visitMode === "single"
    ? <SingleCabForm theme={theme} />
    : <CabFrequentForm theme={theme} />;
}
if (type === "others") {
      // Only show frequent form here
      return visitMode === "single"
        ? <AddPreApprovedVisitor theme={theme} />
        : <AddPreApprovedMulti/>;
    }
